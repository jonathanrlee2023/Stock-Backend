...
stock_labels = {"1": "Bid Price", "2": "Ask Price", "3": "Last Price", "4": "Bid Size", "5": "Ask Size", "33": "Mark"}
file_names = []
new_data = {}
labeled_data = {}
option_ids = []
...
async def start_stock_stream(ticker):
    ...
    request = streamer.level_one_equities(caps_ticker, "0,1,2,3,4,5,33", command="ADD")
...
def parse_option(symbol):
    ...
    if match:
        ...
        return {"ticker": ticker, "year": full_year, "month": month, "day": day, "type": readable_type, "price": price}
    return None
