...
import requests
import datetime
from backtest.backtesting import run_backtest
from core.appState import app_state
import streaming.stream_func as stream_func
from core.dbUtils import get_symbol_id
from core.cache import earnings_lookup, max_fiscal_lookup, symbol_cache, last_checked_cache, r, POPULAR_ETFS
...
async def handleCompany(api_key, rate_key, ticker):
    ...
    if ticker in POPULAR_ETFS:
        ...
        return
    try:
        from company.companyClass import Company
